          ...
          <Container className="mt-4" fluid>
              ...
              <FormGroup className="mb-0">
                ...
                <InputGroup className="input-group-alternative mb-2">
                  ...
                  <Input placeholder="First Name" type="text" name="fname"  onChange={this.onChange}/>
                </InputGroup>
                </Col>
                <Col xl="6">
                <InputGroup className="input-group-alternative mb-2">
                  ...
                  <Input placeholder="Last Name" type="text" name="lname"  onChange={this.onChange}/>
                </InputGroup>
                </Col>
                </Row>
                <InputGroup className="input-group-alternative">
                  ...
                  <Input placeholder="Email address" type="text" name="email"  onChange={this.onChange}/>
                </InputGroup>
                <Row>
